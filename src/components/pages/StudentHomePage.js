...
const StudentHomePage = () => {
  ...
  const SetProgramID = (program) => {
    if (program == "Certificate") {
      formData.programID = 1;
    } else if (program == "Post-Diploma") {
      formData.programID = 2;
    } else if (program == "Diploma") {
      formData.programID = 3;
    }
  };
    ...
    <div>
      ...
      <div className="container flex-center">
        <div className="hero-image-mask">
          <img src="/MegaBanner.jpg" alt="" className="hero-image" />
        </div>
                    ...
                    <Card.Text>
                      <Form>
                        ...
                        <Form.Group controlId="formBasicStartDate">
                          ...
                          <Form.Control
                            type="text"
                            placeholder={result.startingDate}
                            readOnly
                          />
                        </Form.Group>
