...
import "../components/css/CourseSelection.css";
...
class CourseSelection extends Component {
  ...
  filterAvailableCourses = () => {
    ...
    return this.courses.filter((course) => {
      const isAvailableForProgram =
        !selectedProgram || course.program.includes(selectedProgram);
      const isAvailableForTerm =
        !selectedTerm || course.term.includes(selectedTerm);
